...
const styles = StyleSheet.create({
  ...
  headerSub: { fontSize: 13, marginTop: 1, fontFamily: 'Inter_500Medium' },
  qBadge: { paddingHorizontal: 10, paddingVertical: 5, borderRadius: 10 },
  qBadgeText: { fontSize: 11, fontFamily: 'Inter_700Bold', letterSpacing: 0.5 },
  ...
  cardSub: { fontSize: 15, marginTop: 6, fontFamily: 'Inter_500Medium' },
  reasonRow: { flexDirection: 'row', alignItems: 'center', gap: 6, marginTop: 10 },
  reasonText: { fontSize: 13, flex: 1, fontFamily: 'Inter_400Regular' },
  suggestText: { fontSize: 12, textAlign: 'center', marginBottom: 8, fontFamily: 'Inter_600SemiBold' },
  undoLink: { flexDirection: 'row', alignItems: 'center', gap: 4, paddingHorizontal: 6, paddingVertical: 4 },
  undoText: { fontSize: 13, fontFamily: 'Inter_600SemiBold' },
  partsPick: { maxHeight: 180, marginBottom: 10 },
  partPickRow: { flexDirection: 'row', alignItems: 'center', gap: 10, paddingVertical: 9 },
  partPickText: { fontSize: 15, flex: 1, fontFamily: 'Inter_500Medium' },

  groupGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 14, marginTop: 22 },
  groupChip: { width: 72, alignItems: 'center', gap: 6 },
  groupChipText: { fontSize: 11, fontFamily: 'Inter_500Medium', textAlign: 'center' },
  ...
  cmpLabel: { fontSize: 10, fontFamily: 'Inter_700Bold', letterSpacing: 0.5 },
  cmpName: { fontSize: 15, marginTop: 2, fontFamily: 'Inter_700Bold' },
  cmpMeta: { fontSize: 12, marginTop: 2, fontFamily: 'Inter_500Medium' },
  conflictRow: { flexDirection: 'row', alignItems: 'center', gap: 12, marginTop: 8, paddingHorizontal: 12 },
  conflictField: { fontSize: 11, fontFamily: 'Inter_700Bold' },
  conflictVal: { fontSize: 13, fontFamily: 'Inter_500Medium' },
  partsBox: { marginTop: 14, padding: 14, borderRadius: 14, backgroundColor: '#F9FAFB', gap: 4 },
  partLine: { fontSize: 14, fontFamily: 'Inter_500Medium' },
  ...
  allClearTitle: { fontSize: 20, marginTop: 14, fontFamily: 'Inter_700Bold' },
  allClearSub: { fontSize: 14, marginTop: 6, textAlign: 'center', fontFamily: 'Inter_500Medium' },
});
