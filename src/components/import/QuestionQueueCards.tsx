...
const styles = StyleSheet.create({
  ...
  controlRow: { flexDirection: 'row', alignItems: 'center', gap: 10, marginTop: 'auto' },
  backButton: {
    width: 54,
    height: 54,
    borderRadius: 27,
  ...
  secondaryText: { color: IC.ink, fontFamily: 'Inter_600SemiBold', fontSize: 16, lineHeight: 20 },
  primaryText: { color: '#FFFFFF', fontFamily: 'Inter_600SemiBold', fontSize: 16, lineHeight: 20 },
