...
const op = StyleSheet.create({
  ...
  photoCap: { fontSize: 13, fontWeight: '600', color: RC.muted },

  chipWrap: { flexDirection: 'row', flexWrap: 'wrap', gap: 5, marginTop: 4 },
  fieldChip: { backgroundColor: RC.greenSoft, borderRadius: 999, paddingHorizontal: 9, paddingVertical: 4 },
  fieldChipText: { fontSize: 12, fontWeight: '700', color: RC.greenDark },

  selHead: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  selCount: { fontSize: 14, fontWeight: '700', color: RC.ink },
  selAll: { flexDirection: 'row', alignItems: 'center', gap: 6 },
  selAllText: { fontSize: 13, fontWeight: '600', color: RC.muted },
  rowTitle: { fontSize: 15, fontWeight: '600', color: RC.ink },
  rowMeta: { fontSize: 13, fontWeight: '500', color: RC.muted, marginTop: 1 },
  missBadge: { backgroundColor: RC.warnSoft, borderWidth: 1, borderColor: RC.warnLine, borderRadius: 6, paddingHorizontal: 7, paddingVertical: 3 },
  missText: { fontSize: 11, fontWeight: '700', color: RC.warnInk },

  reviewName: { flex: 1, fontSize: 15, fontWeight: '700', color: RC.ink },
  ...
  aiText: { fontSize: 10, fontWeight: '800', color: '#fff' },
  diffLabel: { fontSize: 11, fontWeight: '700', letterSpacing: 0.5, color: RC.muted, marginBottom: 4 },
  diffOld: { fontSize: 13, fontWeight: '500', color: RC.muted, textDecorationLine: 'line-through', marginBottom: 4 },
  ...
  diffNewText: { fontSize: 15, fontWeight: '700', color: RC.greenDark },
  diffNewBody: { fontSize: 14, fontWeight: '500', color: RC.ink2, lineHeight: 20 },
  editHint: { flexDirection: 'row', alignItems: 'center', gap: 5, marginTop: 2 },
  editHintText: { fontSize: 13, fontWeight: '500', color: RC.muted },
});
