...
const s = StyleSheet.create({
  ...
  kicker: {
    fontSize: 11, color: '#5D7E16', fontFamily: 'Inter_700Bold',
    textTransform: 'uppercase', letterSpacing: 0.5,
  },
  title: { fontSize: 15, color: '#18181B', fontFamily: 'Inter_700Bold', marginBottom: 4 },
  summary: { fontSize: 13, color: '#52525B', fontFamily: 'Inter_400Regular', lineHeight: 19, marginBottom: 10 },
  steps: { gap: 8, marginBottom: 12 },
  stepRow: { flexDirection: 'row', gap: 10, alignItems: 'flex-start' },
  stepNum: {
    width: 20, height: 20, borderRadius: 10, backgroundColor: '#EFF7E0', color: '#5C8A0E',
    fontSize: 11, fontFamily: 'Inter_700Bold', textAlign: 'center', lineHeight: 20, overflow: 'hidden',
  },
  stepTitle: { fontSize: 13, color: '#27272A', fontFamily: 'Inter_600SemiBold' },
  stepDetail: { fontSize: 12, color: '#71717A', fontFamily: 'Inter_400Regular', lineHeight: 17, marginTop: 1 },
  ...
  primaryText: { color: '#FFFFFF', fontSize: 13, fontFamily: 'Inter_700Bold' },
  secondary: { backgroundColor: '#F4F4F1' },
  secondaryText: { color: '#3F3F46', fontSize: 13, fontFamily: 'Inter_600SemiBold' },
});
