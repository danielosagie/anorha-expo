...
export const ConversationComposer = ({
  ...
  return (
    <View style={styles.wrap}>
      ...
      {/* Push-to-talk takeover — a tall dark gradient over the whole chat while
          the mic is held (iMessage-style). pointerEvents none so the held mic
          underneath keeps the touch and slide-up tracking works. */}
      {holding && (
...
const styles = StyleSheet.create({
  ...
  holdOverlay: {
    // Full takeover: sit ON TOP and hide everything underneath (the chat list,
    // the chips, the composer) rather than reflowing the layout. Anchored in the
    // footer which has bottom padding, so extend past it and lift the stacking.
    position: 'absolute',
    left: 0,
    right: 0,
    bottom: -200,
