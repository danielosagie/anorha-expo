...
const stubs = new Map<string, string>([
  ['react', 'export const useCallback = () => {}; export const useEffect = () => {}; export const useMemo = () => {}; export const useRef = () => {}; export const useState = () => {};'],
  ...
  ['../lib/platformConnectStatus', 'export const isVisiblePlatformConnection = () => true;'],
]);
